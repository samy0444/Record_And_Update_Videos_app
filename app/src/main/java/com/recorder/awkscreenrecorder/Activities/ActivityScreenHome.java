...
public class ActivityScreenHome extends AppCompatActivity implements HBRecorderListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recordAudioCheckBox = findViewById(R.id.record_audio);
...
//        view = inflater.inflate(R.layout.fragmenthome, container, false);
        context = ActivityScreenHome.this;
    ...
    private void requestcamerapermiss(){
        ActivityCompat.requestPermissions(this, camerapermiss, REQUEST_CAMERA_PERMISSION);
    }
