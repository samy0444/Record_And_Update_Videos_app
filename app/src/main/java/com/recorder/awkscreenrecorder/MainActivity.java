...
public class MainActivity extends AppCompatActivity implements HBRecorderListener {
   ...
   // private FloatingActionButton startbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon.setImageDrawable(context.getDrawable(R.drawable.icon) );
...
// repeat many times:
        ...
        itemIcon.setImageDrawable(context.getDrawable(R.drawable.icon));
        SubActionButton button1 = itemBuilder.setContentView(itemIcon).build();


        ImageView itemIcon2 = new ImageView(this);
        itemIcon2.setImageDrawable(context.getDrawable(R.drawable.icon));
        SubActionButton button2 = itemBuilder.setContentView(itemIcon2).build();

        ImageView itemIcon3 = new ImageView(this);
        itemIcon3.setImageDrawable(context.getDrawable(R.drawable.icon));
        SubActionButton button3 = itemBuilder.setContentView(itemIcon3).build();

        ImageView itemIcon4 = new ImageView(this);
        itemIcon4.setImageDrawable(context.getDrawable(R.drawable.icon));
    ...
    private void initViews() {
        ...
        floating_settings_switch = findViewById(R.id.floating_settings_switch);
    }
