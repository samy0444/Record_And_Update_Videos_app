...
import com.recorder.awkscreenrecorder.Activities.ActivityScreenHome;
import com.recorder.awkscreenrecorder.R;
import com.recorder.awkscreenrecorder.UploadVideos.VideosActivity;


public class VtrimFragment extends Fragment{
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recordvideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(context, ActivityScreenHome.class));
            }
        });
        return view;
    }
